...
The code can be run by cloning the repo then entering the project directory followed by using the command `npm run dev` in terminal to generate a link to the website which can then be opened in any browser.
